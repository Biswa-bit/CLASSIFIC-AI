...
import pandas as pd
from agents.preprocessing.dashboard import PreprocessingDashboard
from agents.preprocessing.report import PreprocessingReport
from agents.preprocessing.recommendation import PreprocessingRecommendation
...
class PreprocessingAgent(BaseAgent):
    ...
    ####################################################
        ...
        self.dashboard = PreprocessingDashboard()

        self.report = PreprocessingReport()

        self.recommendation = PreprocessingRecommendation()
